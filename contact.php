...
mysqli_query($db,"insert into contact values('','$n','$m','$e','$msg',now())");
...
?>
       ...
       <div class="row">
            <div class="col-md-8">
                ...
                <h3><font color="#424141">Contact us </font></h3>
			...
			<div class="col-md-4" style="margin-top:30px">
                ...
                <p>
                    Vellore Institute of Technology<br>Chennai, Tamil Nadu 600127<br>
                </p>
                <p><i class="fa fa-phone"></i> 
                    +91 6389701088 </p>
                <p><i class="fa fa-envelope-o"></i> 
                    <a href="mailto:iammridu01@gmail.com">iammridu01@gmail.com</a>
                </p>
            </div>
        </div>
